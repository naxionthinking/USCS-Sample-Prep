...
<img src="https://raw.githubusercontent.com/Beck-DeYoung-NA/USCS-Sample-Prep/main/Chunk%20Selection.png">

</center>

`USCS_Prep_for_Weighting.Rmd`
...
<img src="https://raw.githubusercontent.com/Beck-DeYoung-NA/USCS-Sample-Prep/main/Knit.png">
...
> The warnings indicate a check is not met. These will be printouts with "Warning:" before them. If a check is passed, a message will be printed with "SUCCESS:" before it. If any warnings are printed, figure out why and report if the warning says to.
...
> &emsp; "SUCCESS: Observed and requested frequencies match for the cell codes"


### **Beck's Questions**
<center>

 `USCS_Prep_for_Weighting`
