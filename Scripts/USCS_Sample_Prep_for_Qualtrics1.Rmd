...
main_code_freq %>%  
  write_csv(f_str("../Files_to_send/Main_Code_Freqs_{MONTH}_{YEAR}.csv"), na ="") 
```
...
cell_code_freq %>% 
  write_csv(f_str("../Files_to_send/Cell_Code_Freqs_{MONTH}_{YEAR}.csv"), na ="")
...
flags_only %>% 
  write_csv(f_str("../Files_to_send/Tenure_or_Spend_Flagged_{MONTH}_{YEAR}.csv"), na ="")
