...
```{r}
MONTH_LONG <- month.name[MONTH_NO] # e.g. "January"
final %>% write_csv("../Files_to_send/Amex_760_{MONTH_LONG}_{YEAR}_All_Sample_Frame_Information_Qualtrics_{Sys.Date()}.csv" %>% f_str(), na ="")
